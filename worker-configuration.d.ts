/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8e2d7aab8f9521ea7782d0304f1b869e)
// Runtime types generated with workerd@1.20251118.0 2025-09-15 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		SECRET_ENVIRONMENT_STATUS: "live";
		SECRET_ADMIN_JWT_SECRET_KEY: string;
		SECRET_USER_JWT_SECRET_KEY: string;
		SECRET_GOOGLE_CLIENT_ID: string;
		SECRET_GOOGLE_CLIENT_SECRET: string;
		PUBLIC_APP_URL: string;
		CARD_GAME_ROOM: DurableObjectNamespace /* CardGameRoom */;
		MATCHMAKING_PLAYER: DurableObjectNamespace /* MatchmakingPlayer */;
		CARD_ART_IMAGES: R2Bucket;
		DB: D1Database;
		AI: Ai;
		ASSETS: Fetcher;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SECRET_ENVIRONMENT_STATUS" | "SECRET_ADMIN_JWT_SECRET_KEY" | "SECRET_USER_JWT_SECRET_KEY" | "SECRET_GOOGLE_CLIENT_ID" | "SECRET_GOOGLE_CLIENT_SECRET" | "PUBLIC_APP_URL">> {}
}
