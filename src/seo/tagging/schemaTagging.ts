...
export function basicWebPageSchemaTags({
	...
	if (previewImage) {
		if (typeof previewImage === "string") {
			...
			const width: QuantitativeValue | undefined =
				previewImage.width !== undefined ? { "@type": "QuantitativeValue", value: previewImage.width } : undefined;
			const height: QuantitativeValue | undefined =
				previewImage.height !== undefined ? { "@type": "QuantitativeValue", value: previewImage.height } : undefined;
			data.image = {
				"@type": "ImageObject",
